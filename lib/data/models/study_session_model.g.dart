...
extension StudySessionModelQueryWhereDistinct
  ...
  QueryBuilder<StudySessionModel, StudySessionModel, QDistinct> distinctByNote(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension StudySessionModelQueryProperty
  ...
  QueryBuilder<StudySessionModel, String?, QQueryOperations> noteProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<StudySessionModel, String, QQueryOperations> subjectProperty() {
    return QueryBuilder.apply(this, (query) {
